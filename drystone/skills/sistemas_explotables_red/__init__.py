...
class SistemasExplotablesRedSkill(BaseSkill):
    ...
    def _skill_specific_traceability(
        ...
        from BaseSkill._build_precheck_traceability into sistemas_explotables_red/traceability.py.
        """
        from drystone.skills.sistemas_explotables_red.traceability import build_traceability
