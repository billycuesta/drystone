...
SKILL_NAME = "secretsmanager"
SKILL_DISPLAY_NAME = "Secrets Manager"
SKILL_CLASS = SecretsManagerSkill
SKILL_WIZARD_SELECTABLE = True
SKILL_WIZARD_LABEL = "Secrets Manager Security Audit"
SKILL_WIZARD_ORDER = 9
